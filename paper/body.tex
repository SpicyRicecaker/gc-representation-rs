...
To test these two algorithms, a dead simple binary tree with a set number of \(10,000,000\) objects will be generated for each implementation of the garbage collection. Then, a seeded random number generator will be used to link \(5,000,000\) random objects with one another in the latter half of the tree. Finally, a number of children will be removed from the top \(10\%\) of parents. This will create enough garbage to 
