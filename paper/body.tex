...
One very popular and easy to implement type of tracing garbage collector is the LISP 2 mark-compact garbage collection algorithm.
...
// 
// we sort the marking map because we wish to preserve the original order of the nodes
